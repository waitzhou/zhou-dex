    ...
    private void setAdapter() {
        ...
        recyclerView.setAdapter(new CommonRecyclerAdapter<HomeworkResp>(this,mRespList,R.layout.item_homework_adapter) {
            ...
            public void convert(CommonRecyclerHolder holder, final HomeworkResp item, int position) {
                ...
                TextView tvDate = holder.getView(R.id.item_tv_date);
                tvDate.setVisibility(View.VISIBLE);
                tvDate.setText(StringUtils.longToDate(item.homeworkDate,"yyyy年MM月dd日 EEEE"));
                if(position != 0){
                    String lastDate = StringUtils.longToDate(mRespList.get(position - 1).homeworkDate,"yyyy-MM-dd");
                    String currentDate = StringUtils.longToDate(mRespList.get(position).homeworkDate,"yyyy-MM-dd");
                ...
                holder.setText(R.id.item_tv_time, StringUtils.longToDate(item.homeworkDate,"HH:mm:ss"));
