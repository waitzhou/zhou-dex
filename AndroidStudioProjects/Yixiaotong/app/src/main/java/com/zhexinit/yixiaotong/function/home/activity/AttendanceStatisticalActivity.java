...
//                    continue;
                switch (i) {
                    case 0:
                        button.setCompoundDrawablesRelativeWithIntrinsicBounds(0, 0, 0, R.drawable.radio_line_late);
                        noData.setText("无迟到记录!");
                        if (mStatisticResp != null && mStatisticResp.beLateList != null) {
                            mType = TYPE_LATE;
                            mStatistics.addAll(mStatisticResp.beLateList);
                        ...
                        break;
                    case 1:
                        button.setCompoundDrawablesRelativeWithIntrinsicBounds(0, 0, 0, R.drawable.radio_line_earlate);
                        noData.setText("无早退记录！");
                        if (mStatisticResp != null &&mStatisticResp.leaveEarlyList != null) {
                        ...
                        break;
                    case 2:
                        button.setCompoundDrawablesRelativeWithIntrinsicBounds(0, 0, 0, R.drawable.radio_line_leave);
                        noData.setText("无请假记录！");
                        if (mStatisticResp != null &&mStatisticResp.leaveList != null) {
                            mType = TYPE_LEAVE;
                        ...
                        break;
                    case 3:
                        button.setCompoundDrawablesRelativeWithIntrinsicBounds(0, 0, 0, R.drawable.radio_line_attentace);
                        noData.setText("无缺勤记录！");
                        if (mStatisticResp != null &&mStatisticResp.absenceList != null) {
                            mType = TYPE_ABSENCE;
